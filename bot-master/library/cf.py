...
db_ip='localhost'
# db 패스워드
db_passwd='sh920616!!' # [mysql password 를 넣어주세요]
...
imi1_accout="8039054411" # [모의투자 계좌번호를 넣어주세요. 주의! 10자리 계좌번호입니다. 모의투자는 8자리 계좌번호 뒤에 11, 실전은 10이 붙어 있음]
...
dart_api_key = '43d6bf8faeab64b9e5c045237e456b4286e63092'
